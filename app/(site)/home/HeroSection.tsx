    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 grid min-h-[640px] grid-cols-12 gap-0 px-8 pt-10">
        ...
        <div className="col-span-6 relative">
          <div className="absolute bottom-0 right-0 h-[320px] w-[240px] translate-x-[10%] translate-y-[10%] rotate-[-8deg] overflow-hidden rounded-lg border-4 border-white shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
            <Image
              src={portrait}
              alt="Portrait"
              fill
