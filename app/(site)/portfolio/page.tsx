  ...
  return (
    <div className="min-h-screen bg-[#D9D9D9] px-8 py-16 text-black">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mx-auto mt-10 max-w-2xl text-center text-sm leading-7 text-black/70">
          {t("pages.portfolio.text")}
        </p>

        {projects.length === 0 ? (
          <div className="mt-12 border-2 border-black bg-white px-10 py-12 text-center">
