    ...
    <div className="min-h-screen bg-[#D9D9D9] px-8 py-16 text-black">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mx-auto mt-10 max-w-xl">
          <div className="border-2 border-black/70 bg-white/40 px-8 py-10">
            <div className="flex flex-col items-center gap-6">
              <div className="grid h-16 w-16 place-items-center rounded-full border-2 border-black bg-white">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 24 24"
              ...
              <div className="text-center">
                ...
                <a
                  ...
                  className="mt-2 inline-block text-sm font-semibold tracking-[0.1em] text-black/80 hover:text-black"
                >
                  t.me/Bumbimbambum
                </a>
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-3 border-2 border-black bg-black px-8 py-3 text-xs font-semibold tracking-[0.25em] text-white transition-colors hover:bg-black/85"
              >
